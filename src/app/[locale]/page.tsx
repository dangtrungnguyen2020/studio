...
export default function Home() {
  ...
  }, [difficulty, customText, isClient, t]);
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-4 mb-6">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button onClick={handleRestart} variant="outline" size="sm" className="w-full sm:w-auto ml-auto">
                      <RefreshCw className="mr-2 h-4 w-4" />
                      {t('restartTest')}
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p dangerouslySetInnerHTML={{ __html: t.raw('restartTooltip')}} />
                  </TooltipContent>
                </Tooltip>
              </div>
