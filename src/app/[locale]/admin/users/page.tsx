...
import { getUsersAndAdminStatus, setAdminStatus } from "@/app/actions/game";
import type { UserWithAdminStatus } from "@/app/actions/game";
import {
  Card,
  CardContent,
  CardDescription,
...
export default function AdminUsersPage() {
  ...
  const handleAdminToggle = async (targetUserId: string, isAdmin: boolean) => {
    ...
    try {
      ...
      setUsers(
        users.map((u) => (u.uid === targetUserId ? { ...u, isAdmin } : u))
      );
      toast({
      ...
      setUsers(
        users.map((u) =>
          u.uid === targetUserId ? { ...u, isAdmin: !isAdmin } : u
        )
      );
    }
  };
                    ...
                    <TableCell className="text-right">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleAdminToggle(u.uid, checked)
                        }
